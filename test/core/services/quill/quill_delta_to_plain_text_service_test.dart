  ...
  group('QuillDeltaToPlainTextService', () {
    ...
    group('Markdown Formatting', () {
      ...
      test('should format italic text', () {
        final doc = _docFromJson(
          '[{"insert":"italic text","attributes":{"italic":true}},{"insert":"\\n"}]',
        );
        final result = QuillDeltaToPlainTextService.call(
          doc.root.toDelta().toJson(),
        );
      ...
      test('should format a link', () {
        final doc = _docFromJson(
          '[{"insert":"Google","attributes":{"link":"https://google.com"}},{"insert":"\\n"}]',
        );
        final result = QuillDeltaToPlainTextService.call(
          doc.root.toDelta().toJson(),
        );
    ...
    group('Lists', () {
      ...
      test(
        'should handle ordered lists exceeding 26 items with fallback to numbers',
        () {
    ...
    group('Embeds', () {
      test('should return an empty string for image embeds', () {
        final doc = _docFromJson(
          '[{"insert":{"media":"path/to/image.png"}},{"insert":"\\n"}]',
        );
        final result = QuillDeltaToPlainTextService.call(
          doc.root.toDelta().toJson(),
        );
      ...
      test('should handle other embeds using toPlainText', () {
        ...
        final doc = _docFromJson(
          '[{"insert":{"video":"path/to/video.mp4"}},{"insert":"\\n"}]',
        );
        final result = QuillDeltaToPlainTextService.call(
          doc.root.toDelta().toJson(),
        );
      ...
      group('Album embed (pipe-delimited format)', () {
        ...
        test('album embed with external URLs is not prefixed', () {
          ...
          expect(
            result,
            '![image](https://a.com/1.jpg)![image](https://b.com/2.jpg)\n',
          );
        });
        ...
        test(
          'video path without includeMarkdownEmbeds produces only newline',
          () {
