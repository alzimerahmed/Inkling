...
void main() {
  group('InitialMapCameraResolver', () {
    test('uses selected place before device or story locations', () async {
      ...
      final result = await resolver.resolve(selectedPlace: PlaceDbModel(latitude: 13.3618, longitude: 103.8606));
    ...
    test('ignores invalid coordinates', () async {
      final resolver = InitialMapCameraResolver(
        ...
        fetchStoryLocations: () async => const <SpLatLng>[SpLatLng(double.nan, 104.9282), SpLatLng(11.5564, 104.9282)],
      );
