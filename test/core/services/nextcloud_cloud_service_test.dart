...
void main() {
  group('NextcloudCloudService', () {
    ...
    test(
      'generic signIn() is a no-op that reports the current state',
      () async {
  ...
  group('NextcloudCloudService.sanitizeFolderName', () {
    ...
    test('trims surrounding whitespace and slashes', () {
      expect(
        NextcloudCloudService.sanitizeFolderName('  myjournal  '),
        'myjournal',
      );
      expect(
        NextcloudCloudService.sanitizeFolderName('/myjournal/'),
    ...
    test('preserves a nested relative path', () {
      expect(
        NextcloudCloudService.sanitizeFolderName('Journals/MyDiary'),
        'Journals/MyDiary',
      );
    });
    ...
    test('drops "." and ".." segments defensively', () {
      expect(
        NextcloudCloudService.sanitizeFolderName('../etc/myjournal'),
        'etc/myjournal',
      );
      expect(
        NextcloudCloudService.sanitizeFolderName('./myjournal'),
