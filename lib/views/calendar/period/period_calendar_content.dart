...
class _PeriodCalendarContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(automaticallyImplyLeading: false, automaticallyImplyActions: false, toolbarHeight: 12),
      ...
      child: MediaQuery(
        ...
        child: Row(
          ...
          children: [
            ...
            Flexible(child: Stack(children: [buildStoryList(context), buildReminderTile(context)])),
          ],
        ),
      ),
    );
  ...
  Widget buildSmallScreenView(BuildContext context) {
    return NestedScrollView(
      ...
      body: Stack(children: [buildStoryList(context), buildReminderTile(context)]),
    );
  }
