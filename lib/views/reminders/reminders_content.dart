...
class _RemindersContent extends StatelessWidget {
  ...
  Widget _buildBuiltinTile(BuildContext context, DevicePreferencesProvider provider, ReminderType type, IconData icon) {
    ...
    return ListTile(
      ...
      subtitle: Text(enabled && reminder != null ? _builtinEnabledSummary(context, type, reminder) : type.description),
