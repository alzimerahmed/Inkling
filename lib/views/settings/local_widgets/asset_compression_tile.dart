...
class AssetCompressionTile extends StatelessWidget {
  const AssetCompressionTile({super.key, required this.currentAssetCompression, required this.onChanged});
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      onTap: () {
        SpAssetCompressionSheet(assetCompression: currentAssetCompression, onChanged: onChanged).show(context: context);
      },
    );
  }
}
