...
class _GalleryTemplateCard extends StatelessWidget {
  const _GalleryTemplateCard({required this.template, required this.onTap});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(template.name, style: TextTheme.of(context).titleMedium),
            Text(template.purpose, style: TextTheme.of(context).bodyMedium),
          ],
        ),
      ),
    );
