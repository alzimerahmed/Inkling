...
class _FeedbackBanner extends StatelessWidget {
  const _FeedbackBanner({required this.context});
  ...
  Widget build(BuildContext context) {
    return MaterialBanner(
      ...
      actions: [buildSuggestButton(context)],
    );
  }
  ...
  Widget buildSuggestButton(BuildContext context) {
    return Padding(
      ...
      child: OutlinedButton.icon(
        ...
        label: Text(tr('button.suggest'), style: TextStyle(color: Theme.of(context).colorScheme.onSurface)),
        onPressed: () {
