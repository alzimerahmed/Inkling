...
class _FontsContent extends StatelessWidget {
  ...
  Widget buildFontFamilyTile(BuildContext context, String fontFamily) {
      ...
      builder: (open) {
        ...
        return ListTile(
          ...
          trailing: !viewModel.available(fontFamily)
              ...
              : Visibility(
                  visible: selected,
                  child: SpFadeIn.fromBottom(child: Icon(SpIcons.checkCircle, color: ColorScheme.of(context).primary)),
                ),
        );
      },
    );
