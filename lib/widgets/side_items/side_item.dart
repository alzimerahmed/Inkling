...
class ListTileSideItem extends BaseSideItem {
  ...
  ListTileSideItem({required this.title, required this.subtitle, required this.icon, required this.onTap});
}

class CustomSideItem extends BaseSideItem {
  final Widget Function(BuildContext context) builder;

  CustomSideItem({required this.builder});

  static BaseSideItem divider({double? height}) => CustomSideItem(builder: (context) => const Divider());

  static BaseSideItem custom({required Widget Function(BuildContext) builder}) =>
