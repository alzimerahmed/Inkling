...
class SpStoryPreferenceTheme extends StatefulWidget {
  const SpStoryPreferenceTheme({super.key, required this.child, required this.preferences});
...
class SpStoryPreferenceThemeConstructor {
  ...
  void _construct() {
    ...
    if (selectedBackground != null) {
      ...
      theme = theme.copyWith(
        ...
        iconButtonTheme: IconButtonThemeData(style: IconButton.styleFrom(foregroundColor: overrideForegroundColor!)),
        textTheme: theme.textTheme.apply(bodyColor: overrideForegroundColor!),
        checkboxTheme: theme.checkboxTheme.copyWith(
          side: BorderSide(color: overrideForegroundColor!, width: theme.checkboxTheme.side?.width ?? 2.0),
        ),
      );
  ...
  static ColorScheme getDarkColorScheme(Color seedColor, DynamicSchemeVariant dynamicSchemeVariant) {
