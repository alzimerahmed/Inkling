...
class SpLayoutTypeSection extends StatelessWidget {
  const SpLayoutTypeSection({super.key, required this.onThemeChanged, required this.selected});
                      ...
                      children: [
                        Material(
                          ...
                          child: InkWell(
                            ...
                            child: AspectRatio(aspectRatio: 148 / 210, child: buildLayoutDemo(layoutType, context)),
                          ),
                        ),
