...
class SpSettingIconBadge extends StatelessWidget {
  const SpSettingIconBadge({super.key, required this.weekday, required IconData icon})
    : _iconData = icon,
      _child = null;

  const SpSettingIconBadge.widget({super.key, required this.weekday, required Widget child})
    : _child = child,
      _iconData = null;
