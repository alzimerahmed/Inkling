...
class SpMultiEditBottomNavBar extends StatelessWidget {
  const SpMultiEditBottomNavBar({super.key, required this.editing, required this.onCancel, required this.buttons});
              ...
              Stack(
                children: [
                  ...
                  Positioned(
                    top: 0,
                    bottom: 0,
                    child: Container(width: 48 / 2 + 8, color: Theme.of(context).colorScheme.surface),
                  ),
                  Positioned(
                    top: 0,
                    left: 8,
