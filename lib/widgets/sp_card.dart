...
class SpCard extends StatelessWidget {
  const SpCard({super.key, this.onTap, required this.child});
            ...
            children: [
              Positioned(
                ...
                child: SpFadeIn.bound(
                  ...
                  child: Image(image: logo, height: logoSize, width: logoSize, fit: BoxFit.fitHeight),
                ),
              ),
              Container(
              ...
              Positioned(
                top: 16.0,
                right: 16.0,
                child: Icon(SpIcons.keyboardRight, color: ColorScheme.of(context).secondary),
              ),
            ],
          );
        },
