...
class SpTemplateInfoSheet extends BaseBottomSheet {
  ...
  SpTemplateInfoSheet({required this.template, required this.persisted});
        ...
        if (persisted) ...[
          if (template.archivedAt != null)
            ListTile(
              ...
              subtitle: Text(timeFormat.formatDateTime(template.archivedAt!, context.locale)),
            ),
          ListTile(
            leading: const Icon(SpIcons.calendar),
            title: Text(tr("list_tile.updated_at.title")),
            subtitle: Text(timeFormat.formatDateTime(template.updatedAt, context.locale)),
          ),
          ListTile(
            leading: const Icon(SpIcons.info),
            title: Text(tr("list_tile.created_at.title")),
            subtitle: Text(timeFormat.formatDateTime(template.createdAt, context.locale)),
          ),
        ],
