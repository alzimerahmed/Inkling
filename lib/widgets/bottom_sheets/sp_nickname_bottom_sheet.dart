...
class SpNicknameBottomSheet extends BaseBottomSheet {
  const SpNicknameBottomSheet({required this.nickname, this.showLogoSelectorOnly = false});
  ...
  Widget buildLogoSelector(BuildContext context, ValueNotifier<AppLogo> appLogoNotifier) {
    return ValueListenableBuilder(
      ...
      builder: (context, appLogo, child) {
        return SpAppLogoPicker(selectedAppLogo: appLogo, onLogoSelected: (logo) => appLogoNotifier.value = logo);
      },
    );
  }
  ...
  TextFormField buildMaterialField(
    ...
    return TextFormField(
      ...
      autocorrect: false,
      decoration: InputDecoration(hintText: tr("input.nickname.hint")),
    );
  }
