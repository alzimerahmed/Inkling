...
class CloudStorageQuotaObject {
  ...
  double? get appFraction => limitInBytes != null && limitInBytes! > 0
      ? appUsageInBytes / limitInBytes!
      : null;

  /// Fraction of total account storage used (0.0 – 1.0), or null if account usage is unknown.
  double? get accountFraction =>
      accountUsageInBytes != null && limitInBytes != null && limitInBytes! > 0
  ...
  factory CloudStorageQuotaObject.fromJson(Map<String, dynamic> json) {
    return CloudStorageQuotaObject(
      ...
      accountUsageInBytes: json['accountUsageInBytes'] != null
          ? (json['accountUsageInBytes'] as num).toInt()
          : null,
      limitInBytes: json['limitInBytes'] != null
          ? (json['limitInBytes'] as num).toInt()
          : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (accountUsageInBytes != null)
        'accountUsageInBytes': accountUsageInBytes,
