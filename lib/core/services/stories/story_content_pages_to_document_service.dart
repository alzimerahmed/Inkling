...
class StoryContentPagesToDocumentService {
  static Future<List<RichTextDocument>> forMultiplePages(
    List<StoryPageDbModel>? richPages,
  ) {
    return compute(_buildDocuments, richPages);
  }

  static List<RichTextDocument> forMultiplePagesSync(
    List<StoryPageDbModel>? richPages,
  ) {
    return _buildDocuments(richPages);
  }

  static Future<RichTextDocument> forSinglePage(
  ...
  static List<RichTextDocument> _buildDocuments(
    List<StoryPageDbModel>? richPages,
  ) {
