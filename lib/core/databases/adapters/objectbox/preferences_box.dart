...
class PreferencesBox extends BaseBox<PreferenceObjectBox, PreferenceDbModel> {
  ...
  _DefinedPreference<DateTime> storageQuotaFetchedAtFor(BackupServiceType serviceType) {
    return switch (serviceType) {
      ...
      BackupServiceType.nextcloud => _DefinedPreference<DateTime>(id: 6, key: 'storage_quota_fetched_at_nextcloud'),
      BackupServiceType.icloud => _DefinedPreference<DateTime>(id: 8, key: 'storage_quota_fetched_at_icloud'),
      BackupServiceType.dropbox => _DefinedPreference<DateTime>(id: 10, key: 'storage_quota_fetched_at_dropbox'),
    };
  }
  ...
  @override
  QueryBuilder<PreferenceObjectBox> buildQuery({Map<String, dynamic>? filters, bool returnDeleted = false}) {
